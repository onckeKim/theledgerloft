...
| D-010 | 2026-09-24 | Add an app-only layer (`design/tokens/app.css`) with darker sage/gold/warning text tones, a navy focus ring and inkMuted control borders | Several store pairings fail WCAG 2.2 AA for small text and form controls | Proposed (owner approval) |
| D-011 | 2026-09-24 | Money format `R 1 234,56` (en-ZA default) vs `R1,234.56` | Must match the store and planner printables | Open (owner to choose) |
